...
urlpatterns = [
    ...
    path('brigades/<int:brigade_id>/update/', brigades.BrigadeUpdateView.as_view(), name='brigade_update'),
    path('brigades/<int:brigade_id>/delete/', brigades.BrigadeDeleteView.as_view(), name='brigade_delete'),
