...
urlpatterns = [
    ...
    path('brigades/work_object_create', brigades.WorkObjectCreateView.as_view(), name='work_object_create_main'),
    ...
    path('brigades/<int:pk>/load-analysis/', brigades.BrigadeLoadAnalysisView.as_view(), name='brigade_load_analysis'),
    path('brigades/load-analysis/', brigades.OrganizationLoadAnalysisView.as_view(), name='organization_load_analysis'),
    path('brigades/<int:pk>/load-analysis/export/', brigades.export_brigade_load_excel, name='brigade_load_export_excel'),
    path('brigades/load-analysis/export/', brigades.export_organization_load_excel, name='organization_load_export_excel'),
    ...
    path('categories/<int:category_id>/delete/', categories.category_delete, name='category_delete'),
